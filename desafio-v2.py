import textwrap
from abc import ABC, abstractmethod, abstractclassmethod, abstractmethod, abstractproperty
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            ...
            print("\n@@@ A operação falhou! Número máximo de saques diários excedido. @@@")
...
def main():
    ...
    while True:
        ...
        if opcao == "1":
            ...
            print("\n@@@ Operação inválida! Selecione uma opção válida para prosseguir. @@@")
